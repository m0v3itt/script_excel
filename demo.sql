...
-- Dumping data for table bd_praia.tb_dias: ~11 rows (approximately)
...
-- Dumping data for table bd_praia.tb_disponibilidade: ~313 rows (approximately)
...
-- Dumping data for table bd_praia.tb_escala: ~5 rows (approximately)
INSERT INTO `tb_escala` (`id_escala`, `id_nadador`, `id_praia`, `id_dia`, `turno`, `codigo`) VALUES
	(215, 6541, 1, 1, 'Manhã', NULL),
	(217, 6541, 1, 1, 'Manhã', NULL),
	(220, 9191, 1, 1, 'Manhã', NULL),
	(222, 7582, 3, 1, 'Manhã', NULL);
...
-- Dumping data for table bd_praia.tb_login: ~1 rows (approximately)
...
-- Dumping data for table bd_praia.tb_nadadores: ~73 rows (approximately)
...
-- Dumping data for table bd_praia.tb_praia: ~52 rows (approximately)
